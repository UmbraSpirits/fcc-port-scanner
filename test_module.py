...
# Added port 25 because that was also open
    def test_port_scanner_url_multiple_ports(self):
        ports = port_scanner.get_open_ports("scanme.nmap.org", [20, 80], False)
        actual = ports
        expected = [22, 25, 80]
        self.assertEqual(
            actual, expected, 'Expected scanning ports of URL address to return [22, 25, 80].')
    ...
    def test_port_scanner_verbose_ip_no_hostname_returned_single_port(self):
        ...
        self.assertEqual(
            actual, expected, "Expected 'Open ports for 104.26.10.78\nPORT     SERVICE\n443      https'")
    ...
    def test_port_scanner_verbose_ip_hostname_returned_multiple_ports(self):
        ...
        self.assertEqual(
            actual, expected, "Expected 'Open ports for hackthissite.org (137.74.187.104)\nPORT     SERVICE\n443      https'")
